...
Command: npx gltfjsx@6.5.3 .\public\models\Modern House_Interior_v2.6.gltf 
*/
...
export function Model(props) {
  const { nodes, materials } = useGLTF('/Modern House_Interior_v2.6.gltf')
  return (
...
useGLTF.preload('/Modern House_Interior_v2.6.gltf')
